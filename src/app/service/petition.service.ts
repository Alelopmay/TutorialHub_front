 ...
 */
   ...
   */
  getPetitionsByTeacher(teacherId: number): Observable<Petition[]> {
    const url = `${this.apiUrl}/petitions/teacher/${teacherId}`;
 ...
 */
   ...
   */
  getPetitionsByClientId(clientId: number): Observable<Petition[]> {
    const url = `${this.apiUrl}/petitions/${clientId}`;
